(() => {
  ...
  function textCandidates(panel) {
    ...
    const candidates = visibleFirst([...panel.querySelectorAll("h1,h2,h3,h4,div,span,p")].filter((el) => !el.closest("button, a, [data-iw-skill-v2-controls], [data-iw-skill-v2-body], [data-iw-skill-v2-action-label], [data-iw-skill-v2-action-glyph], [data-iw-skill-v2-level-readout]")).filter((el) => normText(el.textContent).length <= 130));
